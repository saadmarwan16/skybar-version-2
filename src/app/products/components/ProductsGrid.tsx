          ...
          {products.map((product) => (
            ...
            >
              ...
              <CardContent className="p-6 space-y-4 pt-2">
                ...
                <p className="text-muted-foreground text-sm line-clamp-3 leading-relaxed min-h-[4rem]">
                  {product.description}
                </p>
                ...
                <Button className="w-full h-12 bg-gradient-primary hover:shadow-lg text-primary-foreground font-semibold text-base transition-all duration-300 hover:scale-[1.02]">
                  Import Product
                </Button>
              </CardContent>
            </Card>
